        ...
        <section>
          ...
          <Dl rows={[
            ...
            ...(summary && summary.total - summary.cancelled > 0
              ? ([["Worker review", `${summary.total - summary.cancelled} assigned · ${summary.accepted} accepted · ${summary.rejected} rejected · ${summary.submitted} awaiting review`]] as [string, React.ReactNode][])
              : []),
            ["Last submission", sub
